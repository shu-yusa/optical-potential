...
!====================================================================!
      ...
      do j=lin, l1
        ...
        if (abs(g(j)) >= 1.0d60) then
          g(j) = g(j) / 1.0d60      !divide -> multiply  better? 
          gp(j) = gp(j) / 1.0d60
          indice = indice + 1
...
!!              riccati  1
     ...
     &      *u+838521.0d0)*u+775884.0d0)*u+441450.0d0)               &
     &      *u+141660.0d0)*u+19675.0d0)/6144.0d0
     ...
     &    * x+27.0d0)/1024.0d0
      ...
      tr7 = - ((((((-40320.0d0*x-10560.0d0)*x-13248.0d0)*x+7560.0d0) &
